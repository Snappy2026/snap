// ============================================================================
// MapScreen Component
// Interactive Adult+ Snap Map featuring Bitmoji friend pins, real-time location tags,
// and vibrant dark-mode map UI design matching Adult+ Mobile UI.
// ============================================================================
        ...
        <View style={styles.mapGraphic}>
          ...
          {MAP_FRIENDS.map((friend) => (
            <TouchableOpacity
              ...
              style={[
                styles.pinContainer,
                { top: friend.topPct as any, left: friend.leftPct as any },
              ]}
          ...
          <View style={styles.locationCard}>
            ...
            <View style={styles.cardInfo}>
              ...
              <Text style={styles.cardLoc}>
                📍 {selectedFriend.location} • {selectedFriend.timeAgo}
              </Text>
            </View>
            <TouchableOpacity
